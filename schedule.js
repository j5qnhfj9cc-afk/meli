...
const SCHEDULE = [
  ...
  { day: 3, start: "08:15", end: "09:35", course: "Finanzas Públicas" },
...
function nowPartsInTZ() {
  ...
  const day = new Date(y, mo - 1, da).getDay();
...
// =====================
// 5) PARCIALES: CARGA + PRÓXIMO + CALENDARIO
// =====================
let EXAMS = [];
let viewYear = null;
let viewMonth = null;
